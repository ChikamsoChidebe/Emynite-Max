...
const Automobile = () => {
  ...
  const vehicles = [
    ...
    },
    {
      ...
      features: ["Premium Sound", "Heated Seats", "Panoramic Roof", "AWD"],
      condition: "Excellent",
      rating: 4.8,
      featured: true
    },
    {
      ...
      features: ["Bluetooth", "Cruise Control", "Alloy Wheels", "AC"],
      condition: "Very Good",
      rating: 4.6,
      featured: false
    },
    {
      ...
      features: ["4WD", "7 Seater", "Roof Rails", "Tow Package"],
      condition: "Brand New",
      rating: 4.9,
      featured: true
    },
    {
      ...
      features: ["Sport Package", "Premium Audio", "Wireless Charging", "LED Lights"],
      condition: "Excellent",
      rating: 4.7,
      featured: false
    },
    {
      ...
      transmission: "Automatic",
      image: "https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      features: ["Mark Levinson Audio", "Ventilated Seats", "Head-up Display", "Safety+"],
      condition: "Like New",
      rating: 4.8,
      featured: false
    }
